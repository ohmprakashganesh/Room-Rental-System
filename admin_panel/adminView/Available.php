...
<body>
    ...
    <fieldset>
    <legend>List Available Rooms</legend>
    <?php
 include "../config/conn.php";
    ...
    echo "<td>" . "<a href='../DeleteRoom.php?rid=" . $rid . "'><Button class='abutton' >Delete</Button></a></td>";
          echo "</tr>";
    ...
    echo "<td  colspan='4'>" . "<a href='../Addroom.php'>"."<Button type='button'> ADD </Button></a>"."</td>";
